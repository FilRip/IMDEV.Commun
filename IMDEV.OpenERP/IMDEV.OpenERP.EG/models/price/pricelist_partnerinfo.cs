...
namespace IMDEV.OpenERP.EG.models.price
{
    public class pricelist_partnerinfo : anOpenERPObject
    {
        ...
        {
            get { return (bool)listProperties.value("default_price", aField.FIELD_TYPE.BOOLEAN); }
            set { listProperties.setValue("default_price", value); }
        }
