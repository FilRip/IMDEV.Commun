...
{
    public class SelectFileOrFolderDialog : FileDialog
    {
#region Member Fields
        ...
        public SelectFileOrFolderDialog()
            : base("Select File or Directory")
        {
            ...
            viewsToolStripSplitButton.Enabled = true;
            m_excludeFiles = false;
            base.Text = "Select File or Directory";
        }
