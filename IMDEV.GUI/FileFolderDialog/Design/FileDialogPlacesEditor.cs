...
namespace IMDEV.GUI.FileFolderDialog.Design
{
    internal class FileDialogPlacesEditor : CollectionEditor
    {
        ...
        private class FileDialogPlacesEditorForm : CollectionForm
        {
            ...
            private void InitializeComponent()
            {
                ...
                this.selectedPlaceProps = new FileFolderDialog.Design.VsPropertyGrid(base.Context);
            ...
            private FileFolderDialog.Design.VsPropertyGrid selectedPlaceProps;
