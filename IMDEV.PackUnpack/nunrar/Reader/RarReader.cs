...
namespace NUnrar.Reader
{
    ...
    public abstract class RarReader : IDisposable
    {
        ...
        {
            return Open(stream,listener,RarOptions.KeepStreamsOpen);
        }
        /// <summary>
        ...
        {
            return Open(stream,RarOptions.KeepStreamsOpen);
        }
        /// <summary>
        /// Opens a RarReader for Non-seeking usage with a single volume
        /// </summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static RarReader Open(Stream stream, RarOptions options)
        {
            stream.CheckNotNull("stream");
        ...
        {
            return Open(streams,listener,RarOptions.KeepStreamsOpen);
        }
        /// <summary>
        ...
        {
            return Open(streams, RarOptions.KeepStreamsOpen);
        }
        /// <summary>
        /// Opens a RarReader for Non-seeking usage with multiple volumes
        /// </summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static RarReader Open(IEnumerable<Stream> streams, RarOptions options)
        {
            streams.CheckNotNull("streams");
