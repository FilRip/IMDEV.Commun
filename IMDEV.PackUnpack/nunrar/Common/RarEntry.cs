...
namespace NUnrar.Common
{
    public abstract class RarEntry
    {
        ...
        public bool IsEncrypted
        {
            get
            {
                return FlagUtility.HasFlag(FileHeader.FileFlags,FileFlags.PASSWORD);
            }
        }
        ...
        public bool IsDirectory
        {
            get
            {
                return FlagUtility.HasFlag(FileHeader.FileFlags,FileFlags.DIRECTORY);
            }
        }
        ...
        public bool IsSplit
        {
            get
            {
                return FlagUtility.HasFlag(FileHeader.FileFlags,FileFlags.SPLIT_AFTER);
            }
        }
